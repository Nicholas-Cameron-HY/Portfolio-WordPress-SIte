...
<head>
  ...
  <meta charset="<?php bloginfo( 'charset' ); ?>" />
	...
	<meta name="description" content="Nicholas Cameron is a front-end developer, currently based in Toronto.">

	<!-- Google Plus -->
	<meta itemprop="name" content="Nicholas Cameron">
	<meta itemprop="description" content="Nicholas Cameron is a front-end developer, currently based in Toronto.">
	...
	<meta name="twitter:description" content="Nicholas Cameron is a front-end developer, currently based in Toronto.">
	...
	<meta property="og:description" content="Nicholas Cameron is a front-end developer, currently based in Toronto." /> 
